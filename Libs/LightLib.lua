...
function library:CreateWindow(windowName, keybind, theme)
	...
	DropdownContanier.BackgroundColor3 =
		_G.LightLib_Hub_THEME.Window.TabDataContainer.DropdownHolder.DropdownContanier.BackgroundColor3
		...
		UIS.InputBegan:Connect(function(input)
			if input.KeyCode == _G.LightLib_Hub_KEYBIND then
				...
				elseif UI_TOGGLED ~= true then
					...
					Window:TweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.6, true)
				end
				task.wait(0.25)
				debounce = false
			end
	...
	function tabs:CreateTab(tabName)
					...
					task.spawn(function()
						...
						for _, obj in pairs(TabHolder:GetChildren()) do
							if obj:IsA("TextButton") and obj.Name ~= TabBtn.Name then
								...
								game:GetService("TweenService")
									:Create(obj, TweenInfo.new(0.25), {
										BackgroundColor3 = _G.LightLib_Hub_THEME.Window.TabContainer.TabHolder.TabBtn.NoHover,
									})
									:Play()
								game:GetService("TweenService")
									:Create(obj.TabBtnStroke, TweenInfo.new(0.25), {
										Color = _G.LightLib_Hub_THEME.Window.TabContainer.TabHolder.TabBtn.TabBtnStroke.NoHover,
									})
									:Play()
							end
			...
			if typeof(callback) == "function" then
				...
				task.spawn(function()
					TglBtn.Activated:Connect(function()
						...
						if toggled then
							game:GetService("TweenService")
								:Create(TglBtn, TweenInfo.new(0.25), {
		...
		function tabData:CreateDropdown(name, list, callback)
			...
			TglDropdown.MouseEnter:Connect(function()
				game:GetService("TweenService")
					:Create(TglDropdown, TweenInfo.new(0.25), {
			...
			TglDropdown.Activated:Connect(function()
				...
				if dropdownToggled then
					...
					for i, v in next, list do
						if typeof(i) == "number" or typeof(v) == "string" then
							...
							Select.BackgroundColor3 =
								_G.LightLib_Hub_THEME.Window.TabDataContainer.DropdownHolder.DropdownContanier.DropdownData.Select.NoHover
							...
							DropdownBtnStroke.Color =
								_G.LightLib_Hub_THEME.Window.TabDataContainer.DropdownBtnStroke.Color
							...
							Select.MouseEnter:Connect(function()
								...
								game:GetService("TweenService")
									:Create(Select, TweenInfo.new(0.25), {
									...
									:Play()
								game:GetService("TweenService")
									:Create(DropdownBtnStroke, TweenInfo.new(0.25), {
